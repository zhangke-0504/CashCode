# Composer Input Specification

## Purpose
Define message composition, send and stop controls, focus behavior, and explicit Skill/MCP selection through the two-level capability picker.
